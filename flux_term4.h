...
for (int i = 0; i < 5; ++i) {
  slopa[i] =
      (term3[i] * gam2 + term1[i] - gam5 * (aterml[i] + atermr[i])) / gam0;
}
...
term4[4] =
    aa[0] * (uf0[2] + uf0[0] * xvw02) + aa[1] * (uf0[3] + uf0[1] * xvw02) +
    aa[2] * (uf0[2] * vf0[1] + uf0[0] * vf0[3] + uf0[0] * vf0[1] * wf0[2] +
             uf0[0] * vf0[1] * xvw02) +
    aa[3] * (uf0[2] * wf0[1] + uf0[0] * wf0[3] + uf0[0] * wf0[1] * vf0[2] +
             uf0[0] * wf0[1] * xvw02) +
    aa[4] * (uf0[4] + uf0[0] * vf0[4] + uf0[0] * wf0[4] +
             uf0[0] * xvw02 * xvw02 + 2. * uf0[2] * xvw02 +
             2. * uf0[0] * (vf0[2] * xvw02 + wf0[2] * xvw02 + vf0[2] * wf0[2]));
term4[4] *= 0.5;
